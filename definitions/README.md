...
This folder follows Google's [best practices for repository structure](https://docs.cloud.google.com/dataform/docs/best-practices-repositories#intro-repo-structure) for a Dataform project.
